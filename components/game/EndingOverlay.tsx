...
function recapLines(
  ...
  const hook: Record<EndingType, string> = {
    cure: "这一程，她身上那层所有人都以为的「没问题」被轻轻放下了。真正的答案，还藏在她的记忆深处——也许下一次，她愿意讲给你听。",
    acceptance: "这一程，她学会了带着那层「没问题」继续向前。可有些话她仍没说出口，真正的答案，还锁在记忆深处。",
    awakening: "这一程，她在镜子里看清了自己的一部分。可镜子背面还有一行她没读完的字——那些字，仍留在她的记忆深处。",
    transfer: "这一程，你陪她走到了你能陪的尽头。她的故事还差最后一页，而那页纸，藏在她自己的记忆里，尚未被翻开。",
    dependent: "这一程，她紧紧握住了你的手。可有些裂缝，握得越紧越难愈合——她真正的答案，还锁在记忆深处。",
    worsen: "这一程，裂缝比想象中更深。你没能为她补上，却看清了它最初的形状——它最早，并不是裂在这里的。",
    tragic: "这一程，有些页你没能翻过去。可你最后看见的她，从来不是她来时那一个。她的故事，停在了无人读完的地方。",
    hidden: "这一程，你替她守住了谁都不知道的秘密。而秘密最深处的那只抽屉，仍锁在她的记忆里——钥匙，只在她自己手中。",
  };
  return { title: "你看见的她", lines: [`她来时，是${surface}。`, hook[ending]] };
}
